...
def Visualize():
    ...
    if algo=='Bubble Sort':
        Bubble_Sort(data,float(Speed.get()),draw_data)
    elif algo=='Selection Sort':
        Selection_Sort(data,float(Speed.get()),draw_data)        
    elif algo=="Insertion Sort":
        Insertion_Sort(data,float(Speed.get()),draw_data)
...
if __name__=='__main__':
    mainthr = threading.Thread(target=main)
    mainthr.start()
